...
from arclet.alconna.typing import pattern_gen
...
alc6 = Alconna("test_union", main_args=Args.path[[int, float, 'abc']])
...
alc12 = Alconna("test_str1", Args["abcd"]["1234", "1234"])
